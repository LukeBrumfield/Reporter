  ...
  $.fn.extend({
    tableExport: function(options) {
      var defaults = {
        ...
        type: 'json', // 'json', 'excel', 'doc', 'png' or 'pdf'
      ...
      if (defaults.type == 'excel' || defaults.type == 'xls' || defaults.type == 'word' || defaults.type == 'doc') {
        ...
        var $tables = $(defaults.tableSelector);
        var docData = '';
        ...
        $tables.each(function() {
          ...
          docData += '<table><thead>';
          // Header
          $hrows = $(this).find('thead').first().find('tr');
          $hrows.each(function() {
            trData = "";
            ForEachVisibleCell(this, 'th', rowIndex, $hrows.length,
              function(cell, row, col) {
                if (cell !== null) {
                  trData += '<th style="';
          ...
          docData += '</thead><tbody>';
          // Row Vs Column
          $rows = $(this).find('tbody').first().find('tr');
          $rows.each(function() {
            trData = "";
            ForEachVisibleCell(this, 'td', rowIndex, $hrows.length + $rows.length,
              function(cell, row, col) {
